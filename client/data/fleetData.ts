...
const carrinhas: Car[] = Array.from({ length: 20 }, (_, i) => ({
  ...
  description:
    "Van comercial confiável. Espaço, eficiência e durabilidade comprovada.",
  mainImage:
    "https://cdn.builder.io/api/v1/image/assets%2F2d1ab92b00a64a1cb521942d45c01811%2F8967826605a24ba7a731600e4d32f07f?format=webp&width=800",
  images: [
    {
...
const muscles: Car[] = Array.from({ length: 20 }, (_, i) => ({
  ...
  fuel: "Gasolina",
  description:
    "Muscle car lendário com power e presença. Para os que querem ser notados.",
  mainImage:
...
const maisProc: Car[] = Array.from({ length: 20 }, (_, i) => ({
  ...
  description:
    "Os carros mais populares e confiáveis. Perfeitos para o dia a dia com qualidade garantida.",
  mainImage:
    "https://cdn.builder.io/api/v1/image/assets%2F2d1ab92b00a64a1cb521942d45c01811%2F8967826605a24ba7a731600e4d32f07f?format=webp&width=800",
  images: [
    {
