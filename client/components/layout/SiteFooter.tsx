      ...
      <div className="mx-auto grid max-w-6xl gap-12 px-6 py-14 md:grid-cols-[1.4fr,1fr,1fr] md:px-8">
        <div className="space-y-6">
          ...
          <p className="max-w-lg text-base text-foreground/70">
            Mobilidade premium e experiências completas em Dubai. Da escolha do
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3 text-foreground/70">
            <li className="flex items-start gap-3">
              ...
              <span>
                Frota Justo General Trading — Doha Centre, 29, 40a Street, Al
            ...
            <li className="flex items-center gap-3">
              <Phone className="size-4 text-primary" />
              <a href="tel:+244923951128" className="hover:text-foreground">
                +244 923 951 128
              </a>
            </li>
            <li className="flex items-center gap-3">
              <Phone className="size-4 text-primary" />
              <a href="tel:+244947432971" className="hover:text-foreground">
                +244 947 432 971
              </a>
            </li>
            <li className="flex items-center gap-3">
      ...
      <div className="border-t border-border/60 bg-primary/10">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-6 py-6 text-xs text-foreground/70 md:flex-row md:px-8">
          ...
          <p className="text-center md:text-right">
            Mobilidade inteligente e experiências exclusivas para quem exige
            excelência.
          </p>
        </div>
      </div>
