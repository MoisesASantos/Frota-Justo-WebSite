        ...
        <div className="grid grid-cols-1 gap-0 md:grid-cols-2">
          ...
          <div className="flex flex-col p-6 md:p-8 overflow-y-auto max-h-[90vh] md:max-h-auto">
            ...
            <Button
              type="button"
              size="lg"
              className="mt-auto w-full rounded-full bg-primary text-primary-foreground shadow-lg shadow-primary/20 hover:bg-primary/90 animate-neon-glow hover:animate-none"
